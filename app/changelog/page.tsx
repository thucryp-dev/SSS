...
const entries: ChangelogEntry[] = [
  {
    ...
    kind: "fix",
    items: [
      "🔴 රූප සකස් නොවී තිබූ ගැටළුව නිරාකරණය කළා — රූප සේවාව (Hugging Face) අලුත් ආකාරයකට මාරු වී තිබූ නිසා",
      "🔴 පාඩම් වල හින්දි/දෙමළ අකුරු අහම්බෙන් මිශ්‍ර වීම වළක්වන පරීක්ෂණයක් එකතු කළා — දැන් සිංහල පමණක් සහතික කෙරේ",
      "පාඩම් වල භාෂාව වඩාත් ස්වභාවික, ගුරුවරයෙකු කතා කරන ආකාරයට ළං කළා",
      "යෙදුමේ පෙනුම, බොත්තම්, සහ චලනයන් තව පිරිපහදු කළා — වඩාත් ලස්සන හා පහසු",
      "පෙනීමට අපහසු අයට උපකාරි වන පරිදි බොත්තම් සියල්ලටම නම් එකතු කළා",
    ],
  },
  {
    version: "v2.3",
    ...
    kind: "fix",
    items: [
      "🔴 පාඩම generate වෙන්නේ නැති අවසාන ගැටළුවත් නිරාකරණය කළා — Google ගේ Gemini AI models ටික අලුත් generation එකකට මාරු කළා",
      "දැන් Gemini AI-ගේ නවතම, වේගවත්ම models භාවිතා කරයි",
    ],
  },
  {
    version: "v2.2",
    ...
    kind: "fix",
    items: [
      "🔴 Gemini API key දෝෂය හරියටම නිරාකරණය කළා — කලින් fix එකත් වැරදි විදිහකින් තිබුණා. දැන් AQ.Ab... සහ AIza... key දෙකම එකම ආකාරයට ක්‍රියා කරයි",
      "Key එකක් වැරදි නම් app එක ඉක්මනින්ම (තත්පර 5ට අඩුවෙන්) දැනුම් දෙයි — කලින් තත්පර 30කට වඩා ගතවුණා",
    ],
  },
  {
    version: "v2.1",
